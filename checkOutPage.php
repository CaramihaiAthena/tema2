<?php session_start();
 foreach($_SESSION['cart'] as $key=>$value) {
    $cart = implode(",", $_SESSION['cart'][$key]);
    echo $cart;
 }
...
<html>
    <head>
        ...
        <script src="https://kit.fontawesome.com/29d6ce55df.js" crossorigin="anonymous"></script>
    </head>
    <body>

    <h1>Enter your details</h1>

    <form method="POST" action="paymentSuccessfully.php">
        <label for="fname"><i class="fa fa-user"></i> Full Name</label>
        <input type="text" id="fname" name="firstname" placeholder="John M. Doe">
        <label for="email"><i class="fa fa-envelope"></i> Email</label>
        <input type="text" id="email" name="email" placeholder="john@example.com">
        <label for="street-address"><i class="fa fa-address-card-o"></i>Street address</label>
        ...
        <div class="col-50">
          ...
          <input type="submit" id="pay" name="pay" value="Pay Now">
